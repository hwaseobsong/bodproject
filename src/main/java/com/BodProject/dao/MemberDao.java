...
public interface MemberDao {
	...
	//7월23일
		...
		@Select("SELECT MPREMIUM FROM MEMBER WHERE MID = #{loginId}")
		String getPremiumUser(String loginId);

		@Update("UPDATE MEMBER SET MPREMIUM = 'OK' WHERE MID = #{loginId} ")
		int premiumMemberUpdate(String loginId);

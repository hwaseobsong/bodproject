...
public class BoardController {
	...
	//0714 -추가
		...
		public ModelAndView moveUserBoardList(String userId){
			String loginId = (String)session.getAttribute("loginId");
		...
		//타임라인 프로필 수정
		 ...
		 //내 타임라인
		  ...
		  @RequestMapping(value="/tagTest")
	         ...
	         @RequestMapping(value="likelist", method=RequestMethod.POST, produces="text/plain; charset=UTF-8")
	         public @ResponseBody String likelist(String code) {
	        	 ArrayList<BoardLikeDto> likelist = bsvc.getLikeList(code);
	        	 Gson gson = new Gson();

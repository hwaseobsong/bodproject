...
public class BoardService {
    ...
    public ModelAndView modifyBoardProfile(MemberDto modiMem) throws IllegalStateException, IOException {
       ...
       String premium = mdao.getPremiumUser(modiMem.getMid());
	...
	public ArrayList<BoardLikeDto> getLikeList(String code) {
		ArrayList<BoardLikeDto> likelist = bdao.getLikeList(code);

...
public class MemberService {
	...
	public ModelAndView getNick(String loginId) {
		...
		String premium = mdao.getPremiumUser(loginId);
		System.out.println("premium: "+premium);
		if(premium != null) {
			session.setAttribute("premium", premium);
		}else {
			session.setAttribute("premium", "NO");
		}
...
public String moveMidCheck(String inputMid) {
	...
	public ModelAndView modifyMember(MemberDto modifyMem) throws IllegalStateException, IOException {
		...
		String premium = mdao.getPremiumUser(modifyMem.getMid());
		if(premium != null) {
			session.setAttribute("premium", premium);
		}
	...
	public ModelAndView moveFriendRequest(String userId) {
		...
		//개인정보 확인
	      ...
	      public int friendRequestList(String loginId) {
	       ...
	       public ModelAndView premiumMemberInfo(String loginId) {
				ModelAndView mav = new ModelAndView();
		        ...
		        mav.setViewName("/member/PremiumService");
				
				return mav;
			}
	       

	       public ModelAndView premiumMember(String loginId) {
				ModelAndView mav = new ModelAndView();
				
				int premiumUpdate = mdao.premiumMemberUpdate(loginId);
				if(premiumUpdate> 0) {

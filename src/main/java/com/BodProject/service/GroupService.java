...
public class GroupService {
	...
	String savePath = "C:\\springworkspace\\BodProject\\src\\main\\webapp\\resources\\uploadImg\\groupProfile";
	...
	public String checkGroupName(String gname) {
	      System.out.println("넘어온 그룹명:"+gname);
	...
	public ModelAndView getGroupList(String loginId) {
		ModelAndView mav = new ModelAndView();

                  ...
                  <!-- form -->
                    <form class="md-float-material form-material" action="memberjoin" method="POST" enctype="multipart/form-data" >
                                <div class="row">
                                    <div class="col-sm-9">
                                		<div class="form-group form-primary">
                                    		...
                                    		<span style="font-size:12px" id="midCheckText">아이디를 입력해주세요. (최대 30글자)</span>
                                		</div>
                                	</div>
                                	<div class="col-sm-3">
                                	 ...
                                	 <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            ...
                                            <span style="font-size:12px" id="MPWcheckText"> *영문/숫자 4~20자</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        <div class="form-group form-primary">
                                            ...
                                            <span style="font-size:12px" id="MPWcheckText2" >*영문/숫자 4~20자 </span>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group form-primary">
                                ...
                                <div class="row m-t-10">
                                    <div class="col-md-12">
                                        <button type="submit" onclick="check(); return false;" id="submit" disabled="disabled" class="btnhv btn btn-primary btn-md btn-block waves-effect text-center m-b-20 ">회원가입</button>
                                    </div>
                                </div>
                              </form>
                            </div>
...
function midCheck() {
	...
	if(inputMid.length == 0) {
		$("#midCheckText").css("color" , "red").html("아이디는 1~30자리 입니다.");
	} else {	
	$.ajax({
		type : "get",
		url : "moveIdCheck",
        ...
        $("#input-file").on("change",handleImgFileSelect);
		 ...
		 function pwcheck() {
             ...
             if(MPWcheck.length == 0 || MPWcheck == "") {
            	 $("#MPWcheckText2").html("*영문/숫자 4~20자");
             } else if(inputMPW != MPWcheck) {
             	$("#MPWcheckText2").css("color" , "red").html("비밀번호가 일치하지 않습니다.");
             } else {
             	$("#MPWcheckText2").css("color" , "green").html("비밀번호가 일치합니다.");
             }
        }
        ...
        $(document).ready(function(){
        	...
        	$("#inputMid").keyup(function(){
        		 $("#midCheckText").css("color","red").html("중복확인 버튼을 눌러주세요.");
					...
					$.ajax({
						...
						success : function(result){
							if(inputMNICK.length == 0 || inputMNICK =="") {
								$("#MNICKcheckText").css("color" , "red").html("사용불가능한 닉네임입니다.");
							} else if(result =="OK"){

...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
 ...
 <script type="text/javascript">
                                	$(document).ready(function(){
										...
										$('#adImg').attr('src', '${pageContext.request.contextPath}/resources/ad/ad0' + rand(1,5) + '.gif');
										$('#adImg2').attr('src', '${pageContext.request.contextPath}/resources/ad/ad0' + rand(5,9) + '.gif');
					...
					<nav class="pcoded-navbar" style="font-family: 'Pretendard-Regular';">
                        ...
                        <div class="pcoded-inner-navbar main-menu" >
                            ...
                            <c:if test="${sessionScope.premium == 'NO' }">
                           	<ul>
                                <li class=" " style="text-align:center;">
									<a href="#Redirect"><img id="adImg" style="width:90%; height:auto;" ></a>
									 <div style="height:5px;"></div>
									<a href="#Redirect"><img id="adImg2" style="width:90%; height:auto;" ></a>
                                </li>
                            </ul>
                           	</c:if>
                        </div>

											...
											<div class="col-lg-8" style="border-bottom:1px solid #e8e8e8;">
												<div class="row">
													<div class="col-md-12" style="background-color:white; padding:0px;">
														<div class="blog-entry ftco-animate" style="margin-bottom: 0px; margin-top\: 30px;">
															<div class="author mb-4 d-flex align-items-center" style="margin:20px !important;">
																<!-- 프로필이미지/닉네임 -->
																<c:choose>
																	<c:when test="${boardList.bgcode == null }">
																	<a href="moveUserBoardList?userId=${boardList.bmid}" class="img"
																		style="background-image: url(${boardList.mprofile});"></a>
																		<div class="ml-3 info">
																		<h3>
																			<a href="moveUserBoardList?userId=${boardList.bmid}" style="font-size: 25px; text-decoration:none;">${boardList.bmnick}</a>
																	...
																	<a href="moveGroupPage?gcode=${boardList.bgcode}" class="img"
																		...
																		<div class="ml-3 info">
																			...
																			<a href="moveUserBoardList?userId=${boardList.bmid}" style="font-size: 18px; margin-top:10px; color:black;"
																	...
																	<div class="half order-md-last text-md-right">
																		<p class="meta" style="font-size: 20px;">
																			<i class="${boardList.likemodify}"
																				...
																				style="color: black;"></i>
																				<span id="updateboardlikecount${boardList.bcode}" onclick="javascript:likelist('${boardList.bcode}')">${boardList.likecount}</span>
